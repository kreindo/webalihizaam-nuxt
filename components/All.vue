      ...
      <b-container>
        <div class="section-header">
          ...
          <p style="color: white">
            ...
            memotivasi kita semua untuk bergabung dalam memberikan lebih banyak
            manfaat bagi mereka yang membutuhkan. Mari bersama-sama menjadikan
            ...
            <div class="col-xl-12 col-md-12 services-item filter-product">
              <div class="services-wrap">
                <a
                  ...
                  class="glightbox"
                  ><img src="assets/img/struktur2.png" class="img-fluid" alt=""
                /></a>
              </div>
            </div>
            <!-- End services Item -->
